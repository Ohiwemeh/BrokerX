...
const CryptoAssetRow = memo(({ icon, name, ticker, price, change, isPositive, onClick, isSelected }) => (
  <button 
    onClick={onClick}
...
const Dashboard = () => {
  ...
  const { user, stats, transactions, cryptoPrices } = mockData;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <div className="p-4 sm:p-6 space-y-6">
        ...
        <div>
          <h3 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-3">Market Activity</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-3">Top Cryptocurrencies</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <CryptoAssetRow 
                ...
                name="Tether" 
                ticker="USDT" 
                price={cryptoPrices.tether.usd} 
                change={cryptoPrices.tether.usd_24h_change} 
              ...
              <CryptoAssetRow 
                ...
                name="BNB" 
                ticker="BNB" 
                price={cryptoPrices.binancecoin.usd} 
                change={cryptoPrices.binancecoin.usd_24h_change} 
              ...
              <CryptoAssetRow 
                ...
                change={cryptoPrices.solana.usd_24h_change} 
              ...
              <CryptoAssetRow 
                ...
                name="XRP" 
                ticker="XRP" 
                price={cryptoPrices.ripple.usd} 
                change={cryptoPrices.ripple.usd_24h_change} 
